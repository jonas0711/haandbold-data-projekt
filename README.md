...
CREATE TABLE game_events (
    ...
    Player2_Name TEXT,
    score_update TEXT,
    standardized_team TEXT,
    standardized_action TEXT
);
```
...
- Automatisk logrotation
- Detaljeret fejlsporing
- Performance logging
...
1. PDF Processering Fejl
   - Tjek PDF format og encoding
   - Verificér PDF tilgængelighed

2. Database Fejl
   - Tjek databaserettigheder
   - Verificér SQL queries

3. Web Interface Problemer
   - Tjek Flask logs
   - Verificér browser kompatibilitet

### Support
For support og fejlrapportering, brug GitHub issues systemet.